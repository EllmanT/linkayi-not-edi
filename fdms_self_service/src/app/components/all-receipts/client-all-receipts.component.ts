...
@Component({
  ...
  templateUrl: './client-all-receipts.component.html',
  styleUrl: './client-all-receipts.component.scss'
})
export class ClientAllReceiptsComponent implements OnInit {
// clientTIN :string 
