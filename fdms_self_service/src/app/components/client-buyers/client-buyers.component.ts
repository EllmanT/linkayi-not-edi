...
@Component({
  ...
  templateUrl: './client-buyers.component.html',
  styleUrl: './client-buyers.component.scss'
})
export class ClientBuyersComponent implements OnInit {
  clientTIN:string = localStorage.getItem('token')||"";

  data: TableData = {
    title: '.',
    api: 'clients/GetReceiptsByBuyerTIN',
    type: 'client-buyer',
    columns: ['receiptDate', 'buyerTin','receiptTotal','currency','status',],
    actions: true,
